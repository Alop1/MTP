    ...
    public static function schema_values( $recipe = false ){
        ...
        if (in_array('cp_recipe_category',$_cooked_settings['recipe_taxonomies'])):
            ...
            if (!empty($categories)):
                ...
                $category_url = get_term_link( $category->term_id,'cp_recipe_category' );
            endif;
        endif;
        ...
        $schema_array = apply_filters( 'cooked_schema_array', array(
            ...
            'nutrition' => array(
                ...
                'servingSize' => ( isset($recipe['nutrition']['servings']) && $recipe['nutrition']['servings'] ? $recipe['nutrition']['servings'] : '' ),
