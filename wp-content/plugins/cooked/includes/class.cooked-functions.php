...
');
				...
				foreach ( $cooked_settings_tabs_fields as $key => $val ):
					echo esc_html( "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<key name=\"" . $key . "\">" ) . "<br>";
						foreach ( $val['fields'] as $sub_key => $sub_val ):
							echo esc_html( "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<key name=\"" . $sub_key . "\" />" ) . "<br>";
						endforeach;
...
&nbsp;&nbsp;&nbsp;&nbsp;</admin-texts>
	...
	public static function parse_readme_changelog( $readme_url = false, $title = false ){
		...
		$readme = $readme[0];
		$whats_new_title = '<h3>' . ( $title ? esc_html( $title ) : apply_filters( 'cooked_whats_new_title', esc_html__( "What's new?", "cooked" ) ) ) . '</h3>';
