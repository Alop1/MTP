...
class Cooked_Admin_Menus {
	...
	public function add_menu() {
		...
		add_submenu_page('cooked_recipes_menu', esc_html__('Settings','cooked'), esc_html__('Settings','cooked'), 'edit_cooked_recipes', 'cooked_settings', array(&$this, 'cooked_settings_page') );
		add_submenu_page('cooked_recipes_menu', esc_html__('What\'s New?','cooked'), esc_html__('What\'s New?','cooked'), 'administrator', 'cooked_welcome', array(&$this, 'cooked_welcome_content') );
		if ( !class_exists( 'Cooked_Pro_Plugin' ) ):
			add_submenu_page('cooked_recipes_menu', esc_html__('Upgrade to Pro','cooked'), '<span class="admin-menu-cooked-upgrade">' . esc_html__('Upgrade to Pro','cooked') . '</span>', 'administrator', 'cooked_pro', array(&$this, 'cooked_pro') );
		endif;
