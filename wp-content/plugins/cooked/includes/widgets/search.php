...
class Cooked_Widget_Search extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $size = ( $instance['size'] == 'compact' ? ' compact="true"' : '' );
        $browse = ( $instance['hide_browse'] ? ' hide_browse="true"' : '' );
        $sorting = ( $instance['hide_sorting'] ? ' hide_sorting="true"' : '' );
        echo do_shortcode( '[cooked-search' . $size . $browse . $sorting . ']' );
