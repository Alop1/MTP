...
<div class="umlw-wrapper">
	...
	<div class="umlw-login-avatar">
		<div class="um-col-131"> <!-- href="<?php echo um_user_profile_url(); ?>" -->
			<a href="#" class="um-profile-photo-img" title="<?php echo sprintf( __( 'Welcome %s','login-widget-for-ultimate-member' ), um_user( 'display_name' ) ); ?>"><?php echo get_avatar( $user_id ); ?></a>
		</div>
		<div class="uml-header-info">
			<strong>
			<a href="#" class="uml-name-link"><?php echo um_user( 'display_name' ); ?></a>
			</strong>
			<div>
