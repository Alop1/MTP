...
Upgrade to [Post Slider WD pro](https://web-dorado.com/products/wordpress-post-slider-plugin.html) to get access to following features:
...
###IMPORTANT:    
If you think you found a bug in Post Slider WD or have any problem/question concerning the plugin, please check out [WordPress Post Slider Support Forum](http://web-dorado.com/forum/post-slider-plugin.html) in our website. If you do not find a solution here, do not hesitate to [click here to contact us](https://web-dorado.com/support/contact-us.html).
